"""Convert the Cravitoo App Audit Report markdown into a polished PDF.

Output: /app/frontend/public/cravitoo-app-audit-report.pdf
"""
from pathlib import Path
from markdown_pdf import MarkdownPdf, Section

SRC = Path("/app/CRAVITOO_APP_AUDIT_REPORT.md")
DEST = Path("/app/frontend/public/cravitoo-app-audit-report.pdf")
...
def main() -> None:
    ...
    pdf.meta["title"] = "Cravitoo — Full App Audit Report"
    pdf.meta["author"] = "Cravitoo Engineering"
    pdf.meta["subject"] = "Application audit for developer handover"
